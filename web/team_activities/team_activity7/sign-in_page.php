...
<input type="password" name="userPassword" id="userPassword" pattern="(?=^.{7,}$)(?=.*\d)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required><br><br>
...
if(isset($_POST['LogIn'])) {
 ...
 var_dump($userName);
   ...
   $getUser = $db->prepare('SELECT id, username, password FROM useraccounts WHERE username=:userName');
   var_dump($userData);
	echo "<br>";
	echo "<br>";
	echo "<br>";
