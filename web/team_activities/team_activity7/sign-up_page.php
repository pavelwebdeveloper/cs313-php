...
<input oninput="myFunction()" type="password" name="userPassword" id="userPassword" pattern="[A-Za-z\d{1,}]{7,}" required><span class="asterix"></span><?php if(isset($_SESSION['nomatchmessage'])) {
	echo '<span style="color:red">*</span>';
} ?><br><br>
<label for="duplicateUserPassword">Please, input the password one more time:</label><br>
<input oninput="myFunction()" type="password" name="duplicateUserPassword" id="duplicateUserPassword" pattern="[A-Za-z\d{1,}]{7,}" required><span class="asterix"></span><?php if(isset($_SESSION['nomatchmessage'])) {
	echo '<span style="color:red">*</span>';
} ?><br><br>
...
<input type="hidden" name="SignUp" value="signUp">
 ...
 if (a != b) {
	 ...
	 document.getElementByClassName("asterix").innerHTML = "*";
	 document.getElementByClassName("asterix").style.color = "red";
 } else {
