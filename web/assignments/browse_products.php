...
<html lang="en-us">
 ...
 foreach ($products as $product) {
	...
	"</p><form method='post' action='product_details.php'><input type='hidden' name='productDetails' value='".$product.
	"'><input type='submit' name='productdetails' value='Product details' id='product_details.php'></form></div></article></section>";
